...
namespace BookManager.Api.Swagger
{
            ...
            services.AddSwaggerGen(c =>
            {
                c.SwaggerDoc(SwaggerDocumentVersion,
                    new Info
                    {
                        ...
                        License = new License { Name = "GNU GENERAL PUBLIC LICENSE Version 3", Url = "https://github.com/eduherminio/BookManager/blob/master/LICENSE" }
                    }
                );
